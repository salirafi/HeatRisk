...
OUTPUT_GEOJSON_GZ = BASE_DIR / "tables" / "jakarta_boundary_simplified.geojson.gz"
...
def build_and_export_geojson(gdf: gpd.GeoDataFrame) -> gpd.GeoDataFrame:
    ...
    with gzip.open(OUTPUT_GEOJSON_GZ, "wt", encoding="utf-8") as f:
